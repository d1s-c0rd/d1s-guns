...
mod.valueMods = {{"armorPenetration", 0, "+"}, {"bulletSpeed", -0.1}, {"damage", 0.2}, {"damageMin", 0.2},
                 {"magSize", 0, "+"}, {"maxSpreadIncrease", 0.2}, {"noiseChange", 0, "+"}, {"noiseRadius", 0},
                 {"shotDelay", 0}, {"shotDeviation", -0.05}, {"slowdown", 0, "+"}, {"spreadPerShot", 0.15},
                 {"spreadPerShotMultiplier", 0.1}}
