...
mod.id = "50ae_magazine"
-- price of the weapon mod
mod.price = 2500
-- name of the weapon mod
mod.name = _T("WEAPON_MOD_50AE_CALIBER_CONVERSION_SHORT", ".50 AE Cal.")
-- full name of the weapon mod shown when hovering it in the loadout screen (optional)
mod.nameFull = _T("WEAPON_MOD_50AE_CALIBER_CONVERSION_FULL", ".50 AE Caliber conversion")
...
mod.description = {{_T("WEAPON_MOD_50AE_CALIBER_CONVERSION_DESC", "Converts the weapon to use the .50 AE caliber."),
                    true}}
...
mod.ammoList = ammo.list50AE
-- values applied to the weapon when the mod is installed
-- values are initialized but set to 0, override them in the modOverrides table of the weapon you're adding this mod to
mod.valueMods = {{"armorPenetration", 0, "+"}, {"bulletSpeed", 0}, {"damage", 0}, {"damageMin", 0}, {"magSize", 0, "+"},
                 {"maxSpreadIncrease", 0}, {"noiseChange", 0, "+"}, {"noiseRadius", 0}, {"shotDelay", 0},
                 {"shotDeviation", 0}, {"slowdown", 0, "+"}, {"spreadPerShot", 0}, {"spreadPerShotMultiplier", 0}}
